...
table{width:100%;border-collapse:separate;border-spacing:0;background:var(--panel)}th,td{padding:15px 16px;border-bottom:1px solid var(--line);white-space:nowrap;text-align:left;vertical-align:middle}th{position:sticky;top:0;z-index:2;background:var(--table-head);font-size:13px;font-weight:780;color:var(--ink);cursor:pointer;border-bottom:1px solid var(--line-strong)}td.text,th.text{text-align:left;white-space:normal;min-width:160px}td.num,th.num{text-align:right;font-variant-numeric:tabular-nums}#segments-table th:first-child,#segments-table td:first-child,#segments-table th:last-child,#segments-table td:last-child{text-align:left;white-space:normal;min-width:240px}td:first-child,th:first-child{text-align:left}tbody tr:nth-child(even){background:var(--row-alt)}tbody tr:hover{background:var(--row-hover)}tbody tr:last-child td{border-bottom:0}.sort-mark{font-size:11px;color:#98a2b3;margin-left:6px}
